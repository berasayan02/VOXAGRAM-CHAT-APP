...
const NewDM = () => {
    ...
    const { onlineUsers, setSelectedChatType, setSelectedChatData } = useAppStore.getState();
            ...
            <Dialog open={openNewContactModel} onOpenChange={setOpenNewContactModel}>
                <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
                                        ...
                                        searchedContacts.map((contact) => (
                                            ...
                                            >
                                                <div className="h-12 w-12 relative">
                                                    ...
                                                    ${onlineUsers.find(user => user._id === contact._id)?.isOnline ? "bg-green-500" : "bg-gray-500"}`}
                                                    ></span>
                                                </div>
                    ...
                    }
                    {
                        searchedContacts.length <= 0 && (
                            <div
                                className="flex-1 md:flex flex-col justify-center items-center duration-1000 transition-all mt-5 md:mt-0">
                                <Lottie
